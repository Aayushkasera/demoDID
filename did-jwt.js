...
const jwt = await createJWT(
  { aud: 'did:web:github.com/Aayushkasera/demoDID/new/main', name: 'Bob Smith' },
  { issuer: 'did:web:github.com/Aayushkasera/demoDID/new/main', signer },
  { alg: 'ES256K' }
)
...
verifyJWT(jwt, {
  resolver,
  audience: 'did:web:github.com/Aayushkasera/demoDID/new/main'
